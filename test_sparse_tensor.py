...
class TestLevenbergMarquardt(absltest.TestCase):
  ...
  def test_add_sparse(self):
    ...
    self.assertTrue(
        sparse_tensor.torch.all(add_check == (sparse_jacobian1 + sparse_jacobian2).to_dense())
        .numpy().tolist())
  ...
  def test_add_tensor(self):
    ...
    add_check = self.jac1 + self.jac2
    self.assertTrue(
      sparse_tensor.torch.all(add_check == (sparse_jacobian1 + self.jac2).to_dense())
      .numpy().tolist())
  ...
  def test_sub_sparse(self):
    ...
    self.assertTrue(
        sparse_tensor.torch.all(sub_check == (sparse_jacobian1 - sparse_jacobian2).to_dense())
        .numpy().tolist())
  ...
  def test_sub_tensor(self):
    ...
    sub_check = self.jac1 - self.jac2
    self.assertTrue(
      sparse_tensor.torch.all(sub_check == (sparse_jacobian1 - self.jac2).to_dense())
      .numpy().tolist())
  ...
  def test_mul_sparse(self):
    ...
    self.assertTrue(
        sparse_tensor.torch.all(mul_check == (sparse_jacobian1 * sparse_jacobian2).to_dense())
        .numpy().tolist())
  ...
  def test_mul_tensor(self):
    ...
    mul_check = self.jac1 * self.jac2
    self.assertTrue(
      sparse_tensor.torch.all(mul_check == (sparse_jacobian1 * self.jac2).to_dense())
      .numpy().tolist())
  ...
  def test_transpose(self):
    ...
    self.assertTrue(
        sparse_tensor.torch.all(transpose_check == sparse_jacobian.transpose().to_dense())
        .numpy().tolist())
